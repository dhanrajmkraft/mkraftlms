            ...
            <div class="card-body">
                ...
                <form action="<?php echo site_url('admin/academy_cloud/update'); ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="text" name="access_token" value="<?php echo get_settings('mkraft_cloud_access_token'); ?>" placeholder="<?php echo get_phrase('enter_your_valid_access_token'); ?>">
                    </div>
