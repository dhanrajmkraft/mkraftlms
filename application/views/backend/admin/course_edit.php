...
$(document).ready(function() {
    // Hide thumbnail picker and publish date initially
    $('#thumbnail-picker-area').hide();
    $('#publish_date').hide();

    // Show thumbnail picker and publish date when 'upcoming' is clicked
    $('#upcoming').click(function() {
        $('#thumbnail-picker-area').show();
        $('#publish_date').show();
    });

    // Hide thumbnail picker and publish date for other radio inputs
    $('input[type="radio"]').not('#status_upcoming').click(function() {
        $('#thumbnail-picker-area').hide();
        $('#publish_date').hide();
    });

    // Show thumbnail picker and publish date if status is 'upcoming'
